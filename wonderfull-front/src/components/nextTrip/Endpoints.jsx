                    ...
                    <form className="uk-grid-small" uk-grid>
                      ...
                      <div className="uk-flex uk-form-stacked uk-child-width-1-2 uk-margin-large-bottom">
                        <div className="uk-width-1-2@s uk-margin-right">
                            <label className="uk-form-label uk-text-left" for="form-stacked-text">Begin at</label>
                            <input className="uk-input" type="text" placeholder="Mexico City" />
                        </div>
                        <div className="uk-width-1-2@s">
                            <label className="uk-form-label uk-text-left" for="form-stacked-text">End at</label>
                            <input className="uk-input" type="text" placeholder="Denmark" />
                        </div>
                      </div>

                      <div className="uk-margin">
                        <button className="uk-button uk-button-default">Let's go</button>
                      </div>
                  </form>
                </div>
            </div>
